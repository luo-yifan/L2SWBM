...
[SEAS-hydro Research Version: Chilwa, Malawai, Victoria](NONE) | SEAS-Hydro has (is) doing research on fitting the L2SWBM to three large African lakes. It is underdevelopment. Please seek access directly from Andrew Gronewold at drewgron@umich.edu in the research drive under Q:\Hydro\projects\african_lakes_l2swbm| ![](static/badges/Status-unsupported-red.svg) |
